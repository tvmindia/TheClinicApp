        ...
        <div class="col-sm-12 Span-One ">
            ...
            <div class="col-xs-7  ">
                ...
                <table class="col-phar-patiedet  ">
                    <tr>
                        <td>
                            <label class="control-label col-xs-4 regFormLabels">Category:</label></td>
                        <td style="">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtQty" class="form-control textBoxborder" required runat="server" ValidationGroup="Submit"> </asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>
                            <label class="control-label col-xs-4 regFormLabels">Reference/Bill No:</label></td>
                        <td>
                            <asp:TextBox ID="txtReference" class="form-control textBoxborder numberTypeTextBox" runat="server" required ValidationGroup="Submit"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-md-8">
                        <div class="col-md-12">
                            ...
                            <div class="input-group stylish-input-group">
                                ...
                                <span class="input-group-addon" style="height: 0%;">
                                    <button type="submit" style="height: 0px;" runat="server" id="Button2">
                    ...
                    <div class="col-md-8">
                        <div class="col-md-12">
                            <div class="input-group stylish-input-group">
                                ...
                                <span class="input-group-addon" style="height: 0%;">
                                    <button type="submit" style="height: 0px;" runat="server" id="Button3">
                ...
                <table class="col-phar-patiedet  ">
                    <tr>
                        <td>
                            <label class="control-label col-xs-4 regFormLabels">Category:</label></td>
                        <td style="">
                            <asp:TextBox ID="TextBox1" class="form-control textBoxborder" required runat="server" ValidationGroup="Submit"> </asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox2" class="form-control textBoxborder" required runat="server" ValidationGroup="Submit"> </asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox3" class="form-control textBoxborder" required runat="server" ValidationGroup="Submit"> </asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBox4" class="form-control textBoxborder" required runat="server" ValidationGroup="Submit"> </asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>
                            <label class="control-label col-xs-4 regFormLabels">Reference/Bill No:</label></td>
                        <td>
                            <asp:TextBox ID="TextBox5" class="form-control textBoxborder numberTypeTextBox" runat="server" required ValidationGroup="Submit"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                ...
                <div class="">
                    ...
                    <div class="rounded_corners" style="width: 400px">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="GridView1" runat="server" Style="width: 400px" AutoGenerateColumns="False">
                                    <AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
                                    <Columns>
                                        <%--  <asp:BoundField DataField="MedicineID" HeaderText="MedicineID" />--%>
                                        <asp:BoundField DataField="Name" HeaderText="Medicine Name" />
    ...
    <footer class="footerDiv">
        ...
        <table style="width: 100%; height: 100%;">
            <tr>
                <td class="footerMessagesColumn" style="width: 50%;">
                    <div id="Div1" style="height: 100%; display: none;" runat="server">
                        <a class="close" data-dismiss="alert">×</a>
                ...
                <td style="height: 100%; width: 30%;">
                    <table class="footerTable" style="width: 100%; margin-left: 0px; padding-left: 0px; padding-top: 80%; margin-top: 3%;">
                        <tr>
                            <td style="width: 30%;">
                                <div class="form-group">
                                    <asp:Button ID="Button4" runat="server" Text="ADD STOCK" type="submit" CssClass="button" OnClick="btnStock_Click" ValidationGroup="Submit" />
